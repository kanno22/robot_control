...
#define ZC 0.26//0.240//0.270//0.250
#define DZC 0.0325//0.0575// 
#define DTNUM 2.5//2.5//1.0//2.0
#define DWR 0.0//-0.008//-0.0025//-0.008//-0.015//-0.008//-0.01//-0.005//-0.005//-0.01//-0.025//ZMPより足リンク位置は左右2.5cmほど外側に設定
#define DWL 0.0//0.008//0.0025//0.008//0.015//0.008//0.01//0.005//0.005//0.01//0.025//ZMPより足リンク位置は左右2.5cmほど外側に設定
