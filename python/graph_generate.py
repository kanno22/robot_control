...
file_path_joint_ref = '../log/AY2025/Oct/2025-10-01_18-42-27/log2.csv'
...
file_path_joint = '../log/AY2025/Oct/2025-10-01_18-42-27/log_sensor.csv'

fig_right_path = '../log/AY2025/Oct/2025-10-01_18-42-27/right_leg_plots.png'
fig_left_path = '../log/AY2025/Oct/2025-10-01_18-42-27/left_leg_plots.png'
fig_cog_path = '../log/AY2025/Oct/2025-10-01_18-42-27/cog_plots.png'
fig_top_path='../log/AY2025/Oct/2025-10-01_18-42-27/cog_top.png'
fig_foot_path='../log/AY2025/Oct/2025-10-01_18-42-27/foot_plots.png'
# fig_base_path = '../log/AY2025/Oct/2025-10-01_18-42-27/base_plots.png'
# fig_zmp_path = '../log/AY2025/Oct/2025-10-01_18-42-27/zmp_plots.png'
# fig_cog_xy_path='../log/AY2025/Oct/2025-10-01_18-42-27/cog_xy_plots.png'
...
try:
    # sep='\t'は必須
    df_joint = pd.read_csv(file_path_joint, sep='\t')
    print("CSV file read successfully.")
except FileNotFoundError:
    print(f"Error: The file '{file_path_joint}' was not found.")
    exit()
...
R_hip_roll= df_joint[['R_C_roll_angle', 'R_C_roll_current']]
R_hip_pitch = df_joint[['R_C_pitch_angle', 'R_C_pitch_current']]
R_knee = df_joint['R_linear_dis']
R_ankle_pitch = df_joint[['R_A_pitch_angle', 'R_A_pitch_current']]
R_ankle_roll = df_joint[['R_A_roll_angle', 'R_A_roll_current']]

L_hip_roll= df_joint[['L_C_roll_angle', 'L_C_roll_current']]
L_hip_pitch = df_joint[['L_C_pitch_angle', 'L_C_pitch_current']]
L_knee = df_joint['L_linear_dis']
L_ankle_pitch = df_joint[['L_A_pitch_angle', 'L_A_pitch_current']]
L_ankle_roll = df_joint[['L_A_roll_angle', 'L_A_roll_current']]
...
t_body=df_body['Time']
BODY_a = df_body[['IMU_ddx', 'IMU_ddy', 'IMU_ddz']]
...
ax_cog[0, 0].plot(t_cog.values, COG_p['COG_x'].values, label="COG_x")
...
ax_cog[0, 1].plot(t_cog.values, COG_v['COG_vx'].values, label="COG_dx")
...
ax_cog[0, 2].plot(t_cog.values, COG_a['COG_ax'].values, label="COG_ddx")
...
ax_cog[1, 0].plot(t_cog.values, COG_p['COG_y'].values, label="COG_y")
...
ax_cog[1, 1].plot(t_cog.values, COG_v['COG_vy'].values, label="COG_dy")
...
ax_cog[1, 2].plot(t_cog.values, COG_a['COG_ay'].values, label="COG_ddy")
...
ax_cog[2, 0].plot(t_cog.values, COG_p['COG_z'].values, label="COG_z")
...
ax_cog[2, 1].plot(t_cog.values, COG_v['COG_vz'].values, label="COG_dz")
...
ax_cog[2, 2].plot(t_cog.values, COG_a['COG_az'].values, label="COG_ddz")
